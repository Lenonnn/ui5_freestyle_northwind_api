		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#testenvlenonappproductsnorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testenvlenonappproductsnorthwind-display": {
								"semanticObject": "testenvlenonappproductsnorthwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test.env.lenon.appproductsnorthwind",
									"url": sap.ui.require.toUrl("test/env/lenon/appproductsnorthwind")
								}
							}
						}
					}
